            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        ...
                        <p>If you feel my experience and any kind of tech solution your needs, feel free to contact us.</p>
                    </div>
                </div>
                <div class="col-lg-10">
                                ...
                                <div class="contact-info">
                                    <div class="block mt-0">
                                        ...
                                        <div class="content">Call Us We Will Be Happy To Help
                                            <br> <a href="tel:+XXX111222">01639229419</a> 
                                            <br> <a href="tel:+XXX111222">o1842299275</a> 
                                            <br>Monday - Friday
                                            <br>9AM TO 8PM Eastern Time</div>
                                    </div>
                                    <div class="block mt-4">
                                        <h4 class="h5">Bangladesh Office</h4>
                                        <div class="content">chittagong
                                            {{-- <br>455. --}}
                                            <br>Kazir Dewri</div>
                                    </div>
                                    <div class="block mt-4">
                                        <h4 class="h5"> Office</h4>
                                        <div class="content">Apollo Shopping Center
                                            <br>26.
                                            <br>3rd Floor</div>
                                    </div>
                                    <div class="block">
                                        <ul class="list-unstyled list-inline my-4 social-icons">
                                            <li class="list-inline-item me-3"><a title="Explorer Facebook Profile" class="text-black" href="https://www.facebook.com/profile.php?id=100095711884708&mibextid=ZbWKwL"><i class="fab fa-facebook-f"></i></a>
                                            </li>
